...
* the R dependency is **as old as possible for as long as possible**, and we continuously test against that version; currently, we require at minimum R 3.3.0 (2016).
