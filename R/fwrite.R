fwrite <- function(x, file="", append=FALSE, quote="auto",
                   ...
                   na="", dec=".", col.names=TRUE, qmethod=c("double","escape"), verbose=FALSE, ..turbo=TRUE) {
    ...
    .Call(Cwritefile, x, file, sep, eol, na, dec, quote, qmethod=="escape", append, col.names, verbose, ..turbo)
