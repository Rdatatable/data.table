...
sub_in_funs = function(e, funs) is.call(e) && is.symbol(e[[1L]]) && e[[1L]] %chin% funs
sub_in_funs_length = function(e, funs, n, compare = `==`) is.call(e) && compare(length(e), n) && is.symbol(e[[1L]]) && e[[1L]] %chin% funs
sub_not_funs = function(e, funs) is.call(e) && is.symbol(e[[1L]]) && !e[[1L]] %chin% funs
