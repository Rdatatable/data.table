...
#define INTERNAL_STOP(...) do {snprintf(internal_error_buff, 255, __VA_ARGS__); __halt(0, "%s %s: %s. %s", _("Internal error in"), __func__, internal_error_buff, _("Please report to the data.table issues tracker"));} while (0)
