...
int freadMain(freadMainArgs _args) {
  ...
  int jumpLines = nrowLimit==0 ? 100 : (int)umin(100, nrowLimit);   // how many lines from each jump point to use. If nrows>0 is supplied, nJumps is later set to 1. nrows=0 #4029
  {
