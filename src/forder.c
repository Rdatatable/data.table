...
#define INTERNAL_STOP(...) do {snprintf(msg, 1000, __VA_ARGS__); snprintf(msg, 1000, "%s %s: %s. %s", _("Internal error in"), __func__, msg, _("Please report to the data.table issues tracker")); cleanup(); error("%s", msg);} while (0)
