...
SEXP nafillR(SEXP obj, SEXP type, SEXP fill, SEXP nan_is_na_arg, SEXP inplace, SEXP cols) {
  ...
  SEXP ricols = PROTECT(colnamesInt(obj, cols, ScalarLogical(TRUE),mkString("While matching column names from 'cols' to columns in 'obj'"))); protecti++; // nafill cols=NULL which turns into seq_along(obj)
