...
That is correct. v1.2 was released to CRAN in Aug 2008. Development of v1.3 then continued on r-forge, from
which users installed the latest nightly build, and were very helpful giving feedback and suggestions. As
many versions of v1.3 are in use, we released v1.4 to CRAN as a clean line in the sand.
