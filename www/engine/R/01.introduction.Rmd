...
<p class='lead'> There are several ways in which you can contribute to the<span class='text-info'> data.table</span> project. </p>
<p > If you come across an unexpected behaviour, and you're quite sure of it, then you can <a href="">file a bug</a>. It is even more useful when the bug report consists of a self-contained (small) reproducible example, although we understand that this may not be possible in *all* cases. </p>
...
<p > If you'd like to contribute to the <span class="text-info">data.table</span> project **by involving in development**, you're most welcome! You can start by clicking the `Request to join` link on our <a href="https://r-forge.r-project.org/projects/datatable/">project page</a> </p>
...
<p class='lead'> Here are the list of<span class='text-info'> data.table</span> talks you may find useful. </p>
<div class='bs-example'>
<div class='list-group'>
<span class='list-group-item'>
<a href="http://datatable.r-forge.r-project.org/CologneR_2013.pdf"><span class='lead list-group'> Introduction and news from 1.8.11, Koeln R user group</span> </a> 
