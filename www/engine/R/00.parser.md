...
dt <- data.table(x=1:5, y=6:10) # create a data.table
```
How awesome is that? Now obviously we are not going to discuss every pandoc's markdown syntax in this post. Please go through the website linked above to get familiar with it. Here's the [wiki](https://github.com/jgm/pandoc/wiki) if you wish to learn more. .p{}
.div
