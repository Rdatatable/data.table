...
3. Creating a `data.frame` from an `ITime` vector could lead to renaming of the column name, [#4673](https://github.com/Rdatatable/data.table/issues/4673). Thanks to @shrektan for reporting and @ben-schwen for fixing.
