...
13. `by = col1:col4` no longer produces incorrect result when there is a key on only ```col1``` and ```col4```, [#4285](https://github.com/Rdatatable/data.table/issues/4285). Thanks to @cbilot for reporting.
