...
2. Fix a bug that DT can't `rbind()` two DT with length-0 ordered factors and after that data.table may throw errors complaining "savetl_init checks failed", [#4795](https://github.com/Rdatatable/data.table/issues/4795). Thanks to @shrektan for reporting and fixing.
