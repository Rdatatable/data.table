...
13. Using `eval` together with `:=` inside of `j` argument could have failed in specific cases, [#1181](https://github.com/Rdatatable/data.table/issues/1181). Thanks to @eantonya for reporting.
