...
3. Grouping operations involving columns containing functions that don't inherit the class `'function'` would fail as a result of mistaken S3 dispatch, [#4814](https://github.com/Rdatatable/data.table/issues/4814). Thanks @mb706 for reporting with a simple example and @ecoRoland2 for helping investigate.
