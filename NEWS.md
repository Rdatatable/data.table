...
16. `print.data.table` gains new argument `indices` that allows the user to print a `data.table`'s indices without having to modify the `data.table` itself. Thanks @MichaelChirico for the report and @joshhwuu for the PR.
