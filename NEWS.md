...
5. Joining data.tables on columns of different types could lead to unexpected behaviour in the past in at least two ways [#2592](https://github.com/Rdatatable/data.table/issues/2592):
