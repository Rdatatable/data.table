...
20. `as.data.table.array` method now properly handles the case when some of dimension names are `NULL`, [#3636](https://github.com/Rdatatable/data.table/issues/3636).
