...
14. A type mismatch among levels of the LHS in `dcast` could produce garbage values (some older R versions segfaulted), [#2394](https://github.com/Rdatatable/data.table/issues/2394). Thanks @khotilov for the bug report.
