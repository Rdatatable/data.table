...
1. In rare cases, `data.table` could segfault when joining and grouping in the same operation, [#4892](https://github.com/Rdatatable/data.table/issues/4892). Thanks to @Kodiologist for reporting, @ColeMiller1 for investigating and @tlapak for the PR.
