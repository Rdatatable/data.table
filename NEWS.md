...
11. Using `print.data.table` with `row.names = FALSE` now prints the separator `"---"` row in every value column instead of the `rownames` column, [#4083](https://github.com/Rdatatable/data.table/issues/4083). Thanks @MichaelChirico for the report and @joshhwuu for the fix.
