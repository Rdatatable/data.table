...
3. `as.data.table` method for `xts` objects could have return an incorrect xts index value, [#4897](https://github.com/Rdatatable/data.table/issues/4897). Thanks to @emilsjoerup for reporting.
