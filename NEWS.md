...
13. `rbind` and `rbindlist` now combine `integer64` columns together with non-`integer64` columns correctly, [#1349](https://github.com/Rdatatable/data.table/issues/1349).
