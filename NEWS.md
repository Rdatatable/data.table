...
8. `round()` method for `IDate` gains an argument `week_start` to specify to which weekday to round each input date, e.g. `week_start=2L` means "round to the nearest Monday".
