...
10. `datatable.old.unique.by.key` is now fully deprecated and its usage will result in an error, one year after was advised in the release notes for v1.11.0.
