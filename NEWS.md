...
13. `na.omit` data.table method now returns its input if `cols` argument has got an empty vector, [#2514](https://github.com/Rdatatable/data.table/issues/2514). Thanks to @tdeenes for reporting.
