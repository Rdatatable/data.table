...
14 `all.equal` with `ignore.row.order=TRUE` now properly handles NAs, by using `tolerance=0` argument when no double types columns are present, closes [#4422](https://github.com/Rdatatable/data.table/issues/4422).
