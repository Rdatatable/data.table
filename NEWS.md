...
```
  where 'top' is a non-join column in `Y`; i.e. join inherited column. Thanks to many, especially 
  Eddi, Sadao Milberg and Gabor Grothendieck for extended discussions.
