...
48. `DT[, prod(int64Col), by=grp]` produced wrong results for `bit64::integer64`, [#5225](https://github.com/Rdatatable/data.table/issues/5225). Thanks to Benjamin Schwendinger for reporting and fixing.
