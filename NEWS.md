...
14. Passing `.SD` to `frankv` with `ties.method='random'` or with `na.last=NA` is now fixed, [#4429](https://github.com/Rdatatable/data.table/issues/4429). Thanks @smarches for the report.
