...
7. `copy()` overallocates properly when input is a *nested* list of data.tables, [#4205](https://github.com/Rdatatable/data.table/issues/4205). Thanks to @d-sci for reporting and the PR.
