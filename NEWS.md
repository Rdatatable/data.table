...
5. `na.omit`'s `data.table` method now works to detect missing values in `nanotime` columns as well, [#4744](https://github.com/Rdatatable/data.table/issues/4744). Thanks @vermosen for a related report.
