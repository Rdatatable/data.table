...
31. `:=` works now with GForce optimization, [#1414](https://github.com/Rdatatable/data.table/issues/1414). Thanks to Arun Srinivasan for reporting, and Benjamin Schwendinger for the PR.
