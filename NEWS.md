...
51. `merge.data.table` silently ignored the `incomparables` argument, [#2587](https://github.com/Rdatatable/data.table/issues/2587). Thanks to @GBsuperman for the report and @ben-schwen for the fix.
