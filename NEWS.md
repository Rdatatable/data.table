...
52. assigning j with `:=` could lead to shorter j and recycling if j contained `NULL` values, [#5284](https://github.com/Rdatatable/data.table/issues/5284). Thanks @eutwt for the report, and @ben-schwen for the fix.
