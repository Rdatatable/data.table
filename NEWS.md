...
19. `setnames` now exits early if the `new` names are redundant (i.e. they exactly match the old names), [#3783](https://github.com/Rdatatable/data.table/issues/3783).
