...
8. Clarified that "data.table sorts in `C-locale`" means that upper-case letters may be sorted differently in `setorder` than `base::order`. Thanks to @hughparsonage.
