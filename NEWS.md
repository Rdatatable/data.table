...
5. `groupingsets` edge case of grouping by empty column set and using constant value in `j` now properly handled. Closes [#3173](https://github.com/Rdatatable/data.table/issues/3173).
