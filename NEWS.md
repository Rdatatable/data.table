...
42. `base::rev` gains a fast method `frev(x, copy)` for atomic vectors and lists, [#5885](https://github.com/Rdatatable/data.table/issues/5885). Thanks to Benjamin Schwendinger for suggesting and implementing.
