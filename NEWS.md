...
4. `data.print.char` now handles combination multibyte characters correctly now, [#5096](https://github.com/Rdatatable/data.table/issues/5096). Thanks to @MichaelChirico for the report and @joshhwuu for the fix.
