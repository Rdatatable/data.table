...
1. `fread()`:
    ...
    * Many thanks to @yaakovfeldman (and more to add) for testing in development before release to CRAN and filing issues which have been fixed: [#2070](https://github.com/Rdatatable/data.table/issues/2070)
