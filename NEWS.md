...
31. _Unary_ `-` in `with=FALSE` usage means negation; _binary_ `-` is now interpreted as normal subtraction, [#2019](https://github.com/Rdatatable/data.table/issues/2109). Thanks @cguill95 for the report.
