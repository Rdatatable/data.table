...
test(9999.361, exprCols(x, -"V1,V3", "j", with, environment()), 1:5, warning="not excluded because not found")
...
test(9999.362, exprCols(x, -"V1,V3", ".SDcols", with, environment()), 1:5, warning="not excluded because not found")
## TODO error changed to warning
# Some items of .SDcols are not column names: [V1,V3]
# column(s) not excluded because not found: V1,V3
#test(9999.363, exprCols(x, -"V1,V3", "by", with, environment()), 1:5, warning="not excluded because not found")
test(9999.364, exprCols(x, ((-"V1,V3")), "j", with, environment()), NULL)
test(9999.365, exprCols(x, ((-"V1,V3")), ".SDcols", with, environment()), error="invalid argument to unary operator")
#test(9999.366, exprCols(x, ((-"V1,V3")), "by", with, environment()), NULL)
test(9999.367, exprCols(x, {{-"V1,V3"}}, "j", with, environment()), NULL)
test(9999.368, exprCols(x, {{-"V1,V3"}}, ".SDcols", with, environment()), error="invalid argument to unary operator")
#test(9999.369, exprCols(x, {{-"V1,V3"}}, "by", with, environment()), NULL)
...
test(9999.375, exprCols(x, ((!"V1,V3")), ".SDcols", with, environment()), error="invalid argument type")
#test(9999.376, exprCols(x, ((!"V1,V3")), "by", with, environment()), NULL)
test(9999.377, exprCols(x, {{!"V1,V3"}}, "j", with, environment()), NULL)
test(9999.378, exprCols(x, {{!"V1,V3"}}, ".SDcols", with, environment()), error="invalid argument type")
...
test(9999.425, exprCols(x, ((!1L)), ".SDcols", with, environment()), error="logical and has different length") #4115
...
test(9999.455, exprCols(x, ((!1)), ".SDcols", with, environment()), error="logical and has different length") #4115
...
test(9999.464, exprCols(x, ((1:2)), "j", with, environment()), 1:2)
test(9999.465, exprCols(x, ((1:2)), ".SDcols", with, environment()), 1:2)
#test(9999.466, exprCols(x, ((1:2)), "by", with, environment()), 1:2)
test(9999.467, exprCols(x, {{1:2}}, "j", with, environment()), 1:2)
test(9999.468, exprCols(x, {{1:2}}, ".SDcols", with, environment()), 1:2)
#test(9999.469, exprCols(x, {{1:2}}, "by", with, environment()), 1:2)

#DEV
test(9999.471, exprCols(x, -1:2, "j", with, environment()), 3:5)
test(9999.472, exprCols(x, -1:2, ".SDcols", with, environment()), 2:5)
