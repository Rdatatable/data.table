...
## What are the smaller syntax differences between `data.frame` and data.table {#SmallerDiffs}
 ...
 - Unlike data.frames a data.table cannot store rows with no columns: `nrow(DF[, 0])` returns the number of rows, while `nrow(DT[, 0])` always returns 0; but see issue [#2422](https://github.com/Rdatatable/data.table/issues/2422).
