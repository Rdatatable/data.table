...
* perform fast subsetting, once again, but using the new `on` argument, which builds secondary indices internally for the task (temporarily), and reuses if one already exists,
