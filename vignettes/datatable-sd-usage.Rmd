...
1. The `:=` is an assignment operator to update the `data.table` in place without making a copy. See [*Reference semantics*](datatable-reference-semantics.html) for more.
