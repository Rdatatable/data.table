...
1. a function such as `is.character`
2. name searching with `patterns()`
3. Integer and boolean vectors.
...
2. `names(.SD)` indicates which columns we are updating - in this case we update all entire `.SD`.
