...
`use.index=FALSE` will force query not to use index even if it exists, while `auto.index=FALSE` only disable building index automatically when doing subset on non-indexed data.  
