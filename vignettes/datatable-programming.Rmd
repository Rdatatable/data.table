...
vignette: >
  %\VignetteIndexEntry{Programming data.table}
...
Here instead of using `eval` function we just provide quoted expression into the element of `env` argument.
